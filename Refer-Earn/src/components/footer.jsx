...
const Footer = ({ className = "" }) => {
  const onBenefitsTextClick = useCallback(() => {
    const anchor = document.querySelector("[data-scroll-to='referralImage']");
    if (anchor) {
  ...
  return (
    ...
    >
      <div className="w-[1360px] flex flex-col items-start justify-start gap-[27px] max-w-full">
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-0 pr-[38px] pl-0 box-border max-w-full text-left text-69xl text-gray-100">
