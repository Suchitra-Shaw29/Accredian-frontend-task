    ...
    >
      <div className="w-[1200px] flex flex-col items-start justify-start pt-0 px-6 pb-10 box-border gap-[32.5px] max-w-[1200px] mq900:gap-[16px] mq1300:max-w-full">
        <div className="w-full flex flex-row flex-wrap items-start justify-center max-w-[1200px] mq1300:max-w-full">
          ...
          <div className="w-96 flex flex-col items-center justify-start py-0 px-[67px] box-border max-w-[384px] ml-[-2px] mq450:pl-5 mq450:pr-5 mq450:box-border mq450:max-w-full">
            <Button
              className="self-stretch h-[39px] min-w-[64px]"
              disableElevation
              variant="contained"
              sx={{
                textTransform: "none",
